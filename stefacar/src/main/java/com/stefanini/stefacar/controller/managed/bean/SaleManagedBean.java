...
public class SaleManagedBean implements Serializable {
	...
	public void save() {
		...
		MessengerSystem.notifyInfo("Parab�ns!", "Cadastro de Venda de Carro salvo com sucesso");
		clean();
	}

	public void delete(Sale sale) {
		service.delete(sale);
		MessengerSystem.notifyInfo("Parab�ns!", "Cadastro de Venda de Carro excluido com sucesso");
	}
