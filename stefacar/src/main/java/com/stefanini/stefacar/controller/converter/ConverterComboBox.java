...
@FacesConverter("converterCombobox")
public class ConverterComboBox implements Converter{

	private static final String KEY = ConverterComboBox.class.getCanonicalName();
